...
class YGEditProfile extends StatefulWidget {
  const YGEditProfile({Key? key}) : super(key: key);

  @override
  _YGEditProfileState createState() => _YGEditProfileState();
}

class _YGEditProfileState extends State<YGEditProfile> {
  final ctrlName = TextEditingController(
    text: "Agnes Astri Lestari", // remove 'text' to delete initial value
  );

  final ctrlAddress = TextEditingController(
    text:
        "Jl. Wisata Bukit Mas Blok H-1 No. 12", // remove 'text' to delete initial value
  );

  final ctrlEmail = TextEditingController(
    text: "agneslstr@email.cm", // remove 'text' to delete initial value
  );

  final ctrlPassword = TextEditingController(
    text: "12345678", // remove 'text' to delete initial value
  );
